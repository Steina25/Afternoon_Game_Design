...
def redrawGameWindow():
    global walkCount
    rect_1 = pygame.Rect(390, 380, 80, 480)         #first collum
    pygame.draw.rect(screen, colors.get("GREY4"), rect_1)

    rect_2 = pygame.Rect(30, 580, 300, 100)
    pygame.draw.rect(screen, colors.get("GREY4"), rect_2) #botton left row

    rect_3 = pygame.Rect(120, 380, 300, 100)
    pygame.draw.rect(screen, colors.get("GREY4"), rect_3) # row above last one

    rect_4 = pygame.Rect(120, 180, 150, 300)
    pygame.draw.rect(screen, colors.get("GREY4"), rect_4) # collum above
    
    rect_5 = pygame.Rect(170, 170, 380, 100)
    pygame.draw.rect(screen, colors.get("GREY4"), rect_5) # top row

    rect_6 = pygame.Rect(540, 245, 90, 100)
    pygame.draw.rect(screen, colors.get("GREY4"), rect_6) # single cone

    rect_7 = pygame.Rect(480, 470, 200, 100)
    pygame.draw.rect(screen, colors.get("GREY4"), rect_7) # bottom right

    win.blit(bg, (0,0))
    win.blit(cone, (325, 500))
    win.blit(cone, (325, 400)) #first collum on right of spawn
    win.blit(cone, (325, 300))

    win.blit(cone, (235, 300)) #first row going to the left
    win.blit(cone, (145, 300))

    
    win.blit(cone, (55, 300))
    win.blit(cone, (55, 200))
    
    win.blit(cone, (0, 500))
    win.blit(cone, (90, 500))
    win.blit(cone, (180, 500))
    ...
    win.blit(cone, (505, 400))
    win.blit(coin, (-100, -20))
...
while run:
    ...
    if keys[pygame.K_LEFT] and x < 700 - width - vel:
        ...
        score = MENU_FONT.render("your score is 0!", 1, colors.get("RED"))
